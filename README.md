...
2. Run `npx prisma migrate deploy` against it, then `npm run db:seed` if you want to start from the sheet snapshot (or connect Google and run a live sync instead).
